  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Demo Data Reset</h1>
        ...
        <div className="bg-white rounded-lg shadow p-6 space-y-4">
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-lg">
            <h3 className="font-semibold text-gray-900 mb-2">After Reset:</h3>
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• Access code will be: <code className="bg-gray-200 px-2 py-1 rounded">DEMO-2025-STRATEGY</code></li>
              <li>• Status will be: <code className="bg-gray-200 px-2 py-1 rounded">collecting</code></li>
              <li>• Demo responses will be re-added</li>
              <li>• You can then access the survey at: <code className="bg-gray-200 px-2 py-1 rounded">http://localhost:3000/survey/demo-org/access</code></li>
            </ul>
          </div>
        </div>
      </div>
